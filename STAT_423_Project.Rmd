...
plot_data <- data.frame(response = possible.responses, prop = all.prop, lb = all.lb, ub = all.ub)
...
Skip_class.imputed$Year.Study <- factor(Skip_class.imputed$Year.Study)
