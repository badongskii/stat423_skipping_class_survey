...
#Boxplot visualization for reasons not to skip class
```{R}
...
ggplot(plot_data, aes(x = response, y = prop, fill = response)) + 
  ...
  labs(title = "Reasons for Students Not to Skipping Class (Proportion with 95% CI)", x = "Response", y = "Proportion") +
  theme_minimal()
