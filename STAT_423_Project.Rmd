...
# Gender
leveneTest(Percentage.Skip ~ as.factor(Gender), data = Skip_class.imputed)

# Types.Classes
leveneTest(Percentage.Skip ~ as.factor(Types.Classes), data = Skip_class.imputed)

# Options.Main
leveneTest(Percentage.Skip ~ as.factor(Options.Main), data = Skip_class.imputed)

# Review.missed.material
leveneTest(Percentage.Skip ~ as.factor(Review.missed.material), data = Skip_class.imputed)

# Grades.affected
leveneTest(Percentage.Skip ~ as.factor(Grades.affected), data = Skip_class.imputed)

# Transport
leveneTest(Percentage.Skip ~ as.factor(Transport), data = Skip_class.imputed)
